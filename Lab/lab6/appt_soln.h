// appt_soln.h //
// purpose : header file for appt_soln.cpp
...
const std::string FILENAME = "/comp/11/files/lab5/appointments.data";

// function definitions (written already)
int read_appointments(Appointment appointments[],const std::string filename);
...
Appointment search_for_appointment(Appointment apps[], int len, std::string name);
...
// arguments: An Appointments array, a length of the array, 
//            and a std::string with the name
